...
return {
  {
    ...
    keys = {
      ...
      { '<leader>gu', '<cmd>Gitsigns undo_stage_hunk<CR>',                    desc = 'Gitsigns Undo Stage Buffer' },
      ...
      { '<leader>gb', '<cmd>lua require"gitsigns".blame_line{full=true}<CR>', desc = 'Gitsigns Full Blame Line' },
      ...
      { '<leader>gD', '<cmd>lua require"gitsigns".diffthis("~")<CR>',         desc = 'Gitsigns Diffthis Prev Commit' },
      { '<leader>gt', '<cmd>Gitsigns toggle_deleted<CR>',                     desc = 'Gitsigns Toggle Deleted' },
      -- Text object
