...
return {
  ...
  keys = function()
    ...
    return {
      ...
      { '<leader>dC', repeatable('n', '<plug>(DapRunToCursor)', dap.run_to_cursor), desc = "Dap Run To Cursor" },
      { '<leader>do', repeatable('n', '<plug>(DapStepOver)', dap.step_over), desc = "Dap Step Over" },
      { '<leader>dp', repeatable('n', '<plug>(DapStepBack)', dap.step_back), desc = "Dap Step Back" },
      { '<leader>di', repeatable('n', '<plug>(DapStepInto)', dap.step_back), desc = "Dap Step Into" },
      { '<leader>dO', repeatable('n', '<plug>(DapStepOut)', dap.step_out), desc = "Dap Step Out" },
      { '<leader>de', repeatable('n', '<plug>(DapReverseContinue)', dap.reverse_continue), desc = "Dap Reverse Continue" },
