return {
  {
    ...
    keys = {
      ...
      { 'gI',          '<cmd>Telescope lsp_incoming_calls<CR>', desc = "Telescope Lsp Incoming Calls" },
      { 'gO',          '<cmd>Telescope lsp_outgoing_calls<CR>', desc = "Telescope Lsp_outgoing Calls" },
      { 'gr',          '<cmd>Telescope lsp_references show_line=false<CR>', desc = "Telescope Lsp References" },
      ...
      { '<leader>fib', '<cmd>Telescope current_buffer_fuzzy_find<cr>', desc = "Telescope Current Buffer Fuzzy Find" },
      { '<leader>fit', '<cmd>Telescope current_buffer_tags<cr>', desc = "Telescope Current Buffer Tags" },
      ...
      { '<leader>fwd', '<cmd>lua require"telescope.builtin".diagnostics{bufnr=0}<cr>', desc = "Telescope Buf Diagnostics" },
      { '<leader>fws', '<cmd>Telescope lsp_dynamic_workspace_symbols<cr>', desc = "Telescope Lsp Dynamic Workspace Symbols" },
      { '<leader>fwS', '<cmd>Telescope lsp_document_symbols<cr>', desc = "Telescope Lsp Document Symbols" },
      { '<leader>fwr', '<cmd>Telescope lsp_references show_line=false<cr>', desc = "Telescope Lsp References" },
    },
    dependencies = {
